    ...
    public class EditUserActivity extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            username_text_input_layout = (TextInputLayout) findViewById(R.id.username_text_input_layout);
            role_text_input_layout = (TextInputLayout) findViewById(R.id.role_text_input_layout);
            employee_text_input_layout = (TextInputLayout) findViewById(R.id.employee_text_input_layout);
            retypepassword_text_input_layout = (TextInputLayout) findViewById(R.id.retypepassword_text_input_layout);
            ...
            idRole = (TextView) findViewById(R.id.idRole);
            idRole.setVisibility(View.GONE);
            mToolbar.setTitle("Edit User");
            ...
            if(extras==null){
                ...
                employe = extras.getString("employe");
                username = extras.getString("username");
                id =  extras.getInt("id");
            }
            idRole.setText(""+extras.getInt("idEmploye"));
            id_employee = extras.getInt("idEmploye");
            etUsername.setText(username);
            for(int i=1;i<6;i++){
                if(role.equals("Role Admin "+i)){
                    autoCompleteRole.setText("Role "+i);
                    autoCompleteEmploye.setText("User"+i);
                    id_role = i;
                    id_employee = i;
                }
            }
            ...
            button1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    validasi(id,id_role,id_employee,username,password);
                }
            });
        ...
        private void validasi(Object id,Object mRoleId, Object mEmployeeId, String username, String password){
            if (!validateEmployee() | !validateRole() | !validateUsername() | !validatePassword() | !validateRetypePassword()) {
                return;
            }else{
                editUser(id,mRoleId,mEmployeeId,username,password);
            }
        }
        ...
        private void editUser(Object id,Object mRole,Object mEmployeeId,String username, String password ){
            String json = APIUtilities.editUser(id,username,password,mRole,mEmployeeId);
            ...
            requestAPIServices = APIUtilities.getAPIServices();
            requestAPIServices.editUser(contentType,token,requestBody).enqueue(new Callback<UserAdd>() {
                @Override
